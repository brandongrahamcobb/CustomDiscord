...
//import static com.brandongcobb.discord.service.REPLService.printIt;
    ...
    public CompletableFuture<ToolStatus> run(SearchWebInput input) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            if (query.length() > MAX_QUERY_LENGTH) {
                return new ToolStatusWrapper("Query exceeds maximum allowed length of " + MAX_QUERY_LENGTH + " characters.", false, "Query exceeds maximum allowed length of " + MAX_QUERY_LENGTH + " characters.");
            }
