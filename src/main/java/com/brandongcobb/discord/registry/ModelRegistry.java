...
import com.brandongcobb.discord.enums.*;
import com.brandongcobb.discord.records.*;
import com.brandongcobb.discord.utils.inc.*;
...
public class ModelRegistry {
    ...
    public static final Map<String, ModelInfo> RESPONSE_MODEL_CONTEXT_LIMITS = Map.ofEntries(
        Map.entry("ft:gpt-4o-mini-2024-07-18:spawd:discord:AjZpTNN2", new ModelInfo(Helpers.parseCommaNumber("16,384"), false)),
    ...
    public static final Map<String, ModelInfo> RESPONSE_MODEL_OUTPUT_LIMITS = Map.ofEntries(
        Map.entry("ft:gpt-4o-mini-2024-07-18:spawd:discord:AjZpTNN2", new ModelInfo(Helpers.parseCommaNumber("128,000"), false)),
